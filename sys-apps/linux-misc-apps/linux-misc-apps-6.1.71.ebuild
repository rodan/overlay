...
if [ ${PV/_rc} != ${PV} ]; then
	...
	SRC_URI="https://www.kernel.org/pub/linux/kernel/v6.x/testing/${LINUX_PATCH}
		https://www.kernel.org/pub/linux/kernel/v6.x/testing/v${PATCH_VERSION}/${LINUX_PATCH}"
elif [ $(_get_version_component_count) == 4 ]; then
	# stable-release series
	LINUX_VER=$(ver_cut 1-3)
	LINUX_PATCH=patch-${PV}.xz
	SRC_URI="https://www.kernel.org/pub/linux/kernel/v6.x/${LINUX_PATCH}"
else
	LINUX_VER=${PV}
fi
