...
LICENSE="MIT"
SLOT="0"
IUSE="aac aptx aptx-hd debug hcitop lame ldac man mpg123 ofono static-libs test unwind upower"
RESTRICT="!test? ( test )"
...
multilib_src_configure() {
	local myeconfargs=(
		...
		$(use_with aptx libopenaptx)
		$(use_with aptx-hd libopenaptx)
	)
